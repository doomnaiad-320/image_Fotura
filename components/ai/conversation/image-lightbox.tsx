...
export function ImageLightbox({ imageUrl, alt = '生成的图片', onClose }: ImageLightboxProps) {
  ...
  return (
    ...
    >
      ...
      <button
        onClick={onClose}
        className="absolute top-4 right-4 z-10 p-2 rounded-full bg-muted/80 hover:bg-muted text-foreground transition-colors backdrop-blur-sm"
        aria-label="关闭"
      >
          ...
          <div className="flex items-center justify-between text-foreground text-sm">
            ...
            <div className="flex gap-2">
              ...
              <button
                ...
                className="flex items-center gap-2 px-3 py-1.5 rounded-lg bg-muted/80 hover:bg-muted transition-colors backdrop-blur-sm"
              >
